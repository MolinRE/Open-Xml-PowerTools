...
namespace HtmlConverter01Tests
{
    [TestClass]
    public class GetNpdCardTests
    {
            ...
            using (var memoryStream = new MemoryStream())
            {
                ...
                using (var wDoc = WordprocessingDocument.Open(memoryStream, true))
                {
                    ...
                    var body = htmlElement
                        .Elements()
                        .First(p => p.Name.LocalName == "body")
                        .Elements()
                        .First(p => p.Name.LocalName == "div");
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример эталон.docx";
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример1 приказ ФНС.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример2 приказ ФНС неск изм.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример3 два органа два номера.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример4 три органа три номера.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример5 суд с делом.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример6 без названия.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример7 - разные изменяющие1.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример7 - разные изменяющие2.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример7 суд без дела.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример 8 - АПЕЛЛЯЦИЯ.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример 8 - КАССАЦИЯ.docx";
            var docCard = ConvertToHtml(fileName);
        ...
        {
            string fileName = @"C:\Users\k.komarov\source\example\card\пример9 АОФР изменяющий hak_537.docx";
            var docCard = ConvertToHtml(fileName);
