...
namespace OpenXmlPowerTools
{
    ...
    public class HtmlConverterSettings
    {
        public string PageTitle;
        /// <summary>
        /// The prefix for css class names used when the <see cref="FabricateCssClasses"/> is set.
        /// </summary>
        public string CssClassPrefix;
        /// <summary>
        /// Whether to write css styles in element attributes directly or 
        /// to aggregate them in separate css tag and reference through class names.
        /// </summary>
        public bool FabricateCssClasses;
        public string GeneralCss;
        /// <summary>
    ...
    public static class WmlToHtmlConverter
    {
        ...
        {
            "image/png", "image/gif", "image/tiff", "image/jpeg", "image/x-wmf", "image/x-emf"
        };
            ...
            try
            {
                ...
                using (var partStream = imagePart.GetStream())
                {
                    try
                    {
                        ...
                        {
                            image = new Metafile(partStream);
                        }
                        else
                        {
                            image = new Bitmap(partStream);
                        }
                        ...
                        var result = imageHandler(imageInfo);
                        image.Dispose();
                        return result;
